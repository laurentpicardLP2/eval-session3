...
public class App implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List <Categorie> categories = Arrays.asList(new Categorie("bouclier", 75),new Categorie("Vaisseau spatial", 745),new Categorie("sabre laser", 52), new Categorie("force", 100),new Categorie("colt", 34));
